...
func Slidersave(c *fiber.Ctx) error {
	...
	resp, err := axios.R().
		...
		SetBody(map[string]interface{}{
			...
			"page":            client.Page,
			"sdata":           client.Sdata,
			"slide_movieid":   client.Slide_movieid,
			"slide_urlimage":  client.Slide_urlimage,
			"slide_position":  client.Slide_position,
		}).
		Post(PATH + "api/slidersave")
	if err != nil {
		log.Println(err.Error())
	}
	log.Println("Response Info:")
...
func Sliderdelete(c *fiber.Ctx) error {
	...
	resp, err := axios.R().
		...
		SetBody(map[string]interface{}{
			"client_hostname": hostname,
			"page":            client.Page,
			"slide_id":        client.Slide_id,
		}).
		Post(PATH + "api/sliderdelete")
	if err != nil {
		log.Println(err.Error())
	}
	log.Println("Response Info:")
